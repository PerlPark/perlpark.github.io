  ...
  return (
    <ul className={style.info}>
      <li className={style.info__item}>
        <FontAwesomeIcon icon={faCalendarAlt} size={12} className={style.info__item__icon} />
        {props.date}
      </li>
      
      <li className={style.info__item}>
        <FontAwesomeIcon icon={faStream} size={12} className={style.info__item__icon} />
        {props.timeToRead} minute read
      </li>

      {props.tags && (
        <li className={style.info__item}>
          <FontAwesomeIcon icon={faTag} size={12} className={style.info__item__icon} />
